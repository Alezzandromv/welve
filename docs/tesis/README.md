...
| [`02_CASOS_DE_USO_UML.md`](./02_CASOS_DE_USO_UML.md) | Diagramas de casos de uso (UML formal: actor `«actor»`, caso de uso como elipse) por actor + especificación detallada de los 32 casos de uso |
